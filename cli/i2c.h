...
public:
    i2c_device_t() = default;
    i2c_device_t(const i2c_device_t&) = delete;
    i2c_device_t& operator=(const i2c_device_t&) = delete;
    ~i2c_device_t();
    void close();
    ...
    int read_word_data(uint8_t command, uint16_t &data);
